...
def main(
    ...
    skeleton_format: str = typer.Option(
        "rigv1",
        "--skeleton-format",
        help="Skeleton format: 'rigv1', 'smpl', or 'soma23'.",
    ),
    ...
    if skeleton_format not in ["rigv1", "smpl", "soma23"]:
        print(
            "Error: skeleton_format must be 'rigv1', 'smpl', or "
            f"'soma23'. Got: {skeleton_format}"
        )
        raise typer.Exit(code=1)
