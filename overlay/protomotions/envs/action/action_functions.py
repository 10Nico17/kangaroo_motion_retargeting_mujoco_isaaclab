...
def make_pd_action_config(
    ...
    actuated_indices = torch.tensor(
        robot_config.actuated_dof_indices, dtype=torch.long
    )
    pd_action_offset = pd_action_offset[actuated_indices]
    pd_action_scale = pd_action_scale[actuated_indices]

    joint_names = robot_config.actuated_dof_names
...
def make_bm_pd_action_config(robot_config) -> Dict[str, Any]:
    ...
    pd_action_offset = robot_config.default_dof_pos[
        robot_config.actuated_dof_indices
    ].clone()
