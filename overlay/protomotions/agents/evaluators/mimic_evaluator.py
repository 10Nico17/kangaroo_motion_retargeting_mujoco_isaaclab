...
class MimicEvaluator(BaseEvaluator):
    ...
    def _create_metrics(
        ...
        # Actions do not necessarily cover every observed joint. Kangaroo, for
        # example, observes 32 joint states but controls only 28 actuated
        # joints; its four passive closed-chain joints must not allocate action
        # slots in the evaluation trajectory buffer.
