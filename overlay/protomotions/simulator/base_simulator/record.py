        ...
        if not self.headless:
            ...
            if self._user_is_recording:
                ...
                if (
                    ...
                    # Some backends (currently Newton) render static scene
                    # assets but do not expose dynamic object root states.
                    if (
                        obj_state.root_pos is not None
                        and obj_state.root_rot is not None
                    ):
